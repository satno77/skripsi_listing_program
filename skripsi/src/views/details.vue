    ...
    <div class="row" >
      ...
      <div class="col-sm-auto" v-if="cekDbpedia()== true">
        <div v-for="(i,index) in getAbstractDbpedia" :key="index">
           ...
           <div v-for="(j,index) in fullDetail" :key="index">
                <p v-if="j.sumberBuku">Sumber :{{j.sumberBuku.value}}</p>
           </div>
        </div>
      </div>
      ...
      <div class="col-sm-auto" v-else>
        <span v-for="(i,index) in fullDetail" :key="index">
            ...
            <p v-if="i.sumberBuku">Sumber :{{i.sumberBuku.value}}</p>
        </span>
       ...
       <div class="col-sm-auto" v-for="(i,index) in getImage" :key="index"> 
         <span v-if="i.image">
            ...
            <!--<a v-if="i.linkGambar" v-bind:href="i.linkGambar.value" target="_blank"><p style="text-align:center;">&copy; {{i.SumberGambar.value}}</p></a> -->
    ...
    <div class="moreDetail">
      ...
      <div class="row" >
        <!-- cerita -->
         ...
         <div class="col-sm-2" >
           <div class="Cerita">
             <span v-if="individualCerita.length">
                <router-link to="/detailCerita" v-for="(i,index) in individualCerita" :key="index">
                <p v-if="i.labelIndividu" style="padding-left:30px;" v-on:click="moreInfoCerita(i.labelIndividu.value)">
            ...
            <span v-else><p>Data tidak tersedia</p></span>
           </div>
         </div> <!-- end of cerita -->
        ...
        <!-- tokoh -->
         ...
         <div class="col-sm-2" >
           <div class="tokoh">
             <span v-if="individualTokoh.length">
                <router-link to="/detailTokoh" v-for="(i,index) in individualTokoh" :key="index">
                <p v-if="i.labelIndividu" style="padding-left:30px;" v-on:click="moreInfoTokoh(i.labelIndividu.value)">
                    {{i.labelIndividu.value}}
                </p>
