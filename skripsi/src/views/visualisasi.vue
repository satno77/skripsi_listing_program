<template>
    <div>
        <h5 style="text-align:center; margin-top:2rem">Visualisasi Ontology Seni Pertunjukan</h5>
        <div class="row">
        ...
        <div class="col-md-9 justify-content-md-center" style="margin-top:0.3rem">
        <div id="canvas"></div>
        </div>
      </div><!-- end row -->
    </div>
...
export default {
    ...
    mounted(){
			this.$store.dispatch('visualisasi_')

			var data = this.visualisasi;
			var links = [];
